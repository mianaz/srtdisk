...
> **Tip:** When working from Python/Scanpy exports, you can now call `LoadH5AD()` directly to obtain a `Seurat` object with Visium images and scalefactors reconstructed automatically. The h5Seurat workflows documented here remain the most efficient route for long-term on-disk storage and partial loading.
